...
export function IconRFQ(props: IconProps) {
  return (
    <svg {...base(props)}>
...
export function IconBrand(props: IconProps) {
  return (
    <svg {...base({ ...props, size: props.size ?? 22 })} className={`brand-icon ${props.className ?? ""}`.trim()}>
      <rect x="2" y="2" width="20" height="20" rx="6" fill="currentColor" stroke="none" />
      <path
        d="M7.5 9.5h9l-2.5-2.5M16.5 14.5h-9l2.5 2.5"
...
export function IconStar(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M12 3.5l2.4 4.9 5.4.8-3.9 3.8.9 5.4L12 16.3 7.2 18.4l.9-5.4L4.2 9.2l5.4-.8L12 3.5z" />
    </svg>
  );
}
...
export function IconSparkles(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M12 3l1.9 4.8 4.8 1.9-4.8 1.9L12 16.5l-1.9-4.9L5.3 9.7l4.8-1.9L12 3z" />
...
export function IconLanguages(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M4 5h9M8.5 3v2M6 5c.8 3.5 3.2 6 6 7.5M11 5c-.8 3.5-3.2 6-6.5 7.5" />
